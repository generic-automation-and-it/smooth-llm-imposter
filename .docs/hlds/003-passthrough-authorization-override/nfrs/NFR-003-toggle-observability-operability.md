...
- **Fail-safe default:** every `(dialect, provider)` override is OFF at process start and after restart; there is no
...
- Test: after constructing a fresh application instance, every `(dialect, provider)` override reads OFF.
