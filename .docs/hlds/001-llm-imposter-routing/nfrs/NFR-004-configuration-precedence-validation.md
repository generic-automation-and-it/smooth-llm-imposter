...
name-addressed: `Imposter__Providers__opencode-anthropic__Secret=sk-...`, or the conventional
`OPENCODE_ANTHROPIC_API_KEY=sk-...` (conventional > structured > appsettings). The sibling
