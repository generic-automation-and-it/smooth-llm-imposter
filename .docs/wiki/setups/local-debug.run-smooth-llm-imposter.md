...
# provider prefers <NAME>_API_KEY. Env vars override user secrets — e.g. export OPENCODE_GO_API_KEY /
# OPENROUTER_API_KEY; see Precedence. The structured :Secret below is scheme-agnostic.
