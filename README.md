...
| [010 — Who-Message Introspection](.docs/hlds/010-who-message-introspection/README.md) | Completed | In-band routing probe: a last user message of `who?` (exact match, trimmed) returns a dialect-shaped synthetic reply naming the resolved target and auth scheme; no upstream call |
