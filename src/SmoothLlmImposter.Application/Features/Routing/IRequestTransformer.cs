...
/// decision opts in, injects dialect-appropriate prompt caching. Pure string→string; no I/O.
/// </summary>
public interface IRequestTransformer
{
    ...
    string Transform(string requestBody, RouteDecision decision, string inboundModel);
}
